...
Widget getBoardGameWidget(
  ...
  final double boardSize = getDynamicWidth(context, 85); // Use 85% of the screen width for the board
  final double cellSize = boardSize / 8;
  final double labelSize = getDynamicHeight(context, 4); // Adjust percentage for label size
    ...
    child: Container(
      ...
      child: Column(
        ...
        children: [
                ...
                children: List.generate(8, (index) {
                  return SizedBox(
                    ...
                    child: Center(
                      child: Text(
                        rowLabels[index],
                        style: TextStyle(fontSize: labelSize * 0.4, color: Colors.white),
                      ),
                    ),
                  );
                }),
          ...
          SizedBox(height: getDynamicHeight(context, 1.5)), // Padding between board and column labels
          Row(
            children: [
              SizedBox(width: labelSize), // Fixed width to align with row labels
              SizedBox(
                width: boardSize,
                child: Row(
                  children: List.generate(8, (index) {
                    return SizedBox(
                      ...
                      height: labelSize * 0.8, // Adjust height for column labels
                      child: Center(
                        child: Text(
                          labels[index],
                          style: TextStyle(fontSize: labelSize * 0.4, color: Colors.white),
